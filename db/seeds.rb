...
#   end
Card.create(image: 'test1.png', st: 4, bunya: "連立方程式", ans:234 ,imans1:345 ,imans2:567 ,imans3:678)
Card.create(image: 'test2.png', st: 4, bunya: "整数", ans:234 ,imans1:345 ,imans2:567 ,imans3:678)
